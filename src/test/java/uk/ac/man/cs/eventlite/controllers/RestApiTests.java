...
public class RestApiTests {
    ...
    public void testHomepageJson() throws Exception {
        // Since the homepage JSON is typically generated by a dedicated API controller,
        // you can simulate it by stubbing services if needed. For this example, we
        // assume
        // that the endpoint /api returns a JSON with _links: venues, events, profile.
